...
class JSONStateManager:
    ...
    def __new__(cls):
        ...
        if cls._instance is None:
            cls._instance = super(JSONStateManager, cls).__new__(cls)
            cls._instance._load_state()
        return cls._instance

    @classmethod
    def get_instance(cls):
        """Obtiene la instancia única del JSONStateManager"""
        if cls._instance is None:
    ...
    # Agregar este método al JSONStateManager (paste-3.txt)
